...
|---|---|---|---|---|
| 1 | **The Designer** | `brand-designer` | 10 | Brand Design System in Claude Design + `brand-system.md` |
...
Forty-one minutes of build, three to open, one to close. Forty-five total.

Everything lives in a folder called `marketing-team/`. That folder is the whole point: she walks out owning the system, not a chat transcript.
...
**1. What she's about to get.** One breath: *"By the end of this you'll have five things: a design system in your brand, a positioning document, a map of what's actually working in your space, a database of hooks written for your product, and one finished piece of social content. And you'll keep the whole system, so you can do it again tomorrow with a different product."*

**2. The one thing she needs to bring.** One product or service she wants to sell. Not her whole business. One thing. If she names three, pick the one she's most excited about and say you'll do the others later.
...
**4. The pace.** *"Each of the five takes seven to ten minutes. I'll tell you how long each one is before we start it. If you fall behind, say WHERE AM I and I'll catch you up."*
